"""Django settings for the Online Exam System.

This settings module configures installed apps, middleware, database, REST
framework, JWT authentication, and CORS. Values are primarily sourced from
environment variables for safe environment-specific configuration.
"""
